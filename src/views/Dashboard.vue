<template>
  <div class="min-h-screen bg-gray-50 flex">
    <!-- Sidebar -->
    <aside
      class="fixed lg:sticky top-0 left-0 z-40 w-64 bg-white shadow-lg h-screen overflow-y-auto"
    >
      <div class="flex flex-col h-full">
        ...
        <div class="p-4 m-3 rounded-lg bg-gray-50">
          <div class="flex items-center gap-3">
            <div
              class="w-10 h-10 rounded-full bg-gray-300 flex items-center justify-center text-gray-700 font-medium"
            >
              {{ userInitial }}
            </div>
        ...
        <div class="p-4 border-t border-gray-100">
          <button
            @click="handleLogout"
            class="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200 text-sm"
          >
            <svg
              class="w-4 h-4"
              fill="none"
        ...
        <div v-if="activeTab === 'workspace'" class="space-y-5">
          <div class="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <p class="text-sm text-gray-500 mb-4">
              Temukan fokus terbaik Anda hari ini.
            </p>
            <div class="bg-gray-50 rounded-md p-3 border border-gray-100">
              <p class="text-xs text-gray-600 italic">
                "Kunci utama produktivitas adalah mengelola fokus, bukan waktu."
              </p>
            </div>
          </div>
          ...
          <div class="bg-white rounded-lg border border-gray-200 p-5">
            <div class="mb-4">
              ...
              <p class="text-xs text-gray-500 mt-1">
                Pilih musik latar yang nyaman untuk fokus
              </p>
            </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-5">
              <button
                ...
                :class="[
                  ...
                  currentSound === sound.id && isNoisePlaying
            ...
            <div class="bg-gray-50 rounded-xl p-4">
              <div class="flex flex-col sm:flex-row items-center gap-4">
                <div class="flex gap-1 items-end h-12">
                  <div
                    :class="[
                      'w-1.5 bg-gray-500 rounded-full transition-all duration-150',
                      isNoisePlaying ? 'animate-bounce' : 'h-3',
                      isNoisePlaying ? 'h-6' : '',
                    ]"
                  ></div>
                  <div
                    :class="[
                      'w-1.5 bg-gray-600 rounded-full transition-all duration-150',
                      isNoisePlaying
                  ...
                  <div
                    :class="[
                      'w-1.5 bg-gray-700 rounded-full transition-all duration-150',
                      isNoisePlaying
                ...
                >
                  ...
                  <input
                    ...
                    step="0.01"
                    v-model="noiseVolume"
                    @input="updateNoiseVolume"
                    class="flex-1 h-1.5 rounded-full appearance-none bg-gray-300"
                  />
                  <span class="text-xs text-gray-500 w-10"
                    >{{ Math.round(noiseVolume * 100) }}%</span
                  >
                </div>
              </div>
              ...
              <div
                v-if="isNoisePlaying"
                class="mt-3 text-center border-t border-gray-200 pt-3"
              >
        ...
        <div v-if="activeTab === 'tasks'" class="space-y-5">
          <div class="flex justify-between items-center">
            ...
            <button
              ...
              class="px-3 py-1.5 bg-gray-800 text-white rounded-md text-sm hover:bg-gray-700 transition flex items-center gap-1"
            >
              <svg
                class="w-4 h-4"
                fill="none"
            ...
            <div class="bg-gray-50 rounded-lg p-3">
              ...
              <div class="space-y-2">
                <div
                  ...
                  :key="task.id"
                  class="bg-white rounded-md p-3 border border-gray-200 opacity-75"
                >
                  <div class="flex justify-between items-start mb-1">
                    <span
                      :class="[
                  ...
                  <h4 class="font-medium text-gray-500 text-sm line-through">
                    {{ task.title }}
                  </h4>
          ...
          >
            ...
            >
              <div class="flex justify-between items-start mb-2">
                <div class="flex gap-1">
                  <button
                    @click="updateNoteColor(note, 'pastel-blue')"
                    class="w-4 h-4 rounded-full bg-blue-200 hover:ring-1 hover:ring-gray-400"
                  ></button>
                  <button
                    @click="updateNoteColor(note, 'pastel-pink')"
                    class="w-4 h-4 rounded-full bg-pink-200 hover:ring-1 hover:ring-gray-400"
                  ></button>
                  <button
                    @click="updateNoteColor(note, 'pastel-purple')"
                    class="w-4 h-4 rounded-full bg-purple-200 hover:ring-1 hover:ring-gray-400"
                  ></button>
                  <button
                    @click="updateNoteColor(note, 'pastel-green')"
                    class="w-4 h-4 rounded-full bg-green-200 hover:ring-1 hover:ring-gray-400"
                  ></button>
                  <button
                    @click="updateNoteColor(note, 'pastel-amber')"
                    class="w-4 h-4 rounded-full bg-amber-200 hover:ring-1 hover:ring-gray-400"
                  ></button>
                </div>
                <button
              ...
              <input
                ...
                placeholder="Judul..."
                class="w-full bg-transparent border-none text-sm font-medium text-gray-800 focus:outline-none mb-1 placeholder-gray-400 p-0"
              />
              <textarea
                ...
                rows="3"
                class="w-full bg-transparent border-none text-xs text-gray-600 focus:outline-none resize-none placeholder-gray-400 p-0"
              ></textarea>
            </div>
            <div v-if="notes.length === 0" class="col-span-full">
              ...
              >
                ...
                <p class="text-sm text-gray-500">
                  Belum ada catatan. Klik tombol di atas untuk membuat catatan!
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            >
              ...
              <div class="relative w-48 h-48 mx-auto mb-6">
                ...
                >
                  <div class="text-3xl font-semibold text-gray-800 font-mono">
                    {{ formattedTime }}
                  </div>
                  <div class="text-xs text-gray-500 mt-1">
                    {{ isBreakTime ? "Istirahat" : "Fokus" }}
                  </div>
                </div>
              </div>
              <div class="flex justify-center gap-3">
                <button
                  @click="resetTimer"
                  class="w-9 h-9 rounded-full bg-gray-100 text-gray-600 hover:bg-gray-200 flex items-center justify-center"
                >
                  <svg
                    class="w-4 h-4"
                    fill="none"
                ...
                <button
                  @click="toggleTimer"
                  class="px-5 py-2 bg-gray-800 text-white rounded-md text-sm hover:bg-gray-700 flex items-center gap-1"
                >
                  <svg
                    class="w-4 h-4"
                    fill="none"
              ...
              <div class="space-y-2">
                <button
                  ...
                  :class="[
                    ...
                    currentTheme === theme.id
                      ? 'bg-gray-100 border border-gray-200 ring-1 ring-gray-400'
                ...
                >
                  ...
                  <div
                    ...
                    class="w-5 h-5 rounded-full bg-gray-800 flex items-center justify-center"
                  >
                    <svg
        ...
        <form @submit.prevent="addTask" class="space-y-3">
          <div>
            ...
            <input
              ...
              required
              class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-1 focus:ring-gray-400"
            />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-700 mb-1"
          ...
          <div class="flex gap-2 pt-3">
            <button
              ...
              class="flex-1 px-3 py-2 border border-gray-300 rounded-md text-sm text-gray-700 hover:bg-gray-50"
            >
              Batal
            </button>
            <button
              type="submit"
              class="flex-1 px-3 py-2 bg-gray-800 text-white rounded-md text-sm hover:bg-gray-700"
            >
              Simpan
            </button>
          </div>
...
const soundOptions = [
  {
    ...
    description: "Musik lo-fi santai untuk fokus maksimal",
    frequency: 400,
    type: "melody",
  },
  {
    id: "jazz-smooth",
    name: "Jazz Santai",
    icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9h8M8 13h6M8 17h4M6 5h12a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V7a2 2 0 012-2z"/><path d="M12 9v8"/></svg>',
    description: "Jazz lembut yang menenangkan pikiran",
    frequency: 380,
    type: "melody",
  },
  {
    id: "piano-relax",
    name: "Piano Relaks",
    icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2zm0 0v4h14V3M7 7v10M12 7v10M17 7v10"/></svg>',
    description: "Alunan piano yang damai dan menyejukkan",
    frequency: 420,
    type: "melody",
  },
  {
    ...
    description: "Guitar akustik untuk suasana hangat",
    frequency: 390,
    type: "melody",
  },
  {
    id: "rain-nature",
    name: "Hujan & Alam",
    icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"/><path d="M12 19v2m-4-2v2m8-2v2"/></svg>',
    description: "Suara hujan dan alam yang natural",
    frequency: 350,
    type: "noise",
  },
  {
    id: "ocean-waves",
    name: "Ombak Laut",
    icon: '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12h.01M7 12h.01M11 12h.01M15 12h.01M19 12h.01M21 12h.01M4 8h.01M8 8h.01M12 8h.01M16 8h.01M20 8h.01M5 16h.01M9 16h.01M13 16h.01M17 16h.01M21 16h.01"/></svg>',
    description: "Suara ombak yang menenangkan hati",
    frequency: 280,
    type: "noise",
  },
];
...
const playPianoMelody = () => {
  const melody = [
    261.63, 293.66, 329.63, 261.63, 329.63, 349.23, 392.0, 349.23, 329.63,
    293.66, 261.63,
  ];
  let step = 0;
  const playPianoNote = () => {
  ...
  if (isTimerRunning.value) {
    ...
    timerInterval = setInterval(() => {
      if (timerSeconds.value > 0) {
        ...
        showToast(
          isBreakTime.value ? "Waktu istirahat! 🎉" : "Waktu fokus selesai! 💪",
        );
      }
    }, 1000);
  }
...
<!-- Tambahkan ini di luar scoped (global) -->
<style>
/* Tema Space (Default) */
body.theme-space {
...
<style>
/* Reset transisi untuk semua elemen */
* {
...
body.theme-space .bg-gray-200 {
  background-color: #e5e7eb !important;
}

body.theme-space .border-gray-100 {
...
body.theme-space .border-gray-300 {
...
body.theme-space h3.text-gray-800,
body.theme-space h4.text-gray-800 {
  color: #1f2937 !important;
}

body.theme-space .text-gray-700 {
...
body.theme-space .text-gray-400 {
  color: #9ca3af !important;
}

body.theme-space .bg-gray-800,
body.theme-space button.bg-gray-800,
body.theme-space .bg-gray-800.rounded-md {
...
/* Card utama - yang tadinya putih jadi putih tapi border berubah */
body.theme-sunset .bg-white,
body.theme-sunset aside.bg-white,
body.theme-sunset .modal-card.bg-white,
body.theme-sunset .rounded-lg.bg-white {
  background-color: #ffffff !important;
}

/* Background abu-abu jadi warna sunset */
body.theme-sunset .bg-gray-50,
body.theme-sunset .rounded-lg.bg-gray-50,
body.theme-sunset .bg-gray-50.rounded-xl,
body.theme-sunset .bg-gray-50.rounded-lg,
body.theme-sunset .bg-gray-50.rounded-md {
  background-color: #fff7ed !important;
}

body.theme-sunset .bg-gray-100,
body.theme-sunset .bg-gray-100.rounded-md {
  background-color: #ffedd5 !important;
}

body.theme-sunset .bg-gray-200 {
  background-color: #fed7aa !important;
}

/* Border semua jadi warna sunset */
body.theme-sunset .border-gray-100,
body.theme-sunset .border.border-gray-100 {
  border-color: #ffedd5 !important;
}

body.theme-sunset .border-gray-200,
body.theme-sunset .border.border-gray-200 {
  border-color: #fed7aa !important;
}

body.theme-sunset .border-gray-300 {
  border-color: #fdba74 !important;
}

/* Text semua jadi warna sunset */
body.theme-sunset .text-gray-800,
body.theme-sunset h1.text-gray-800,
body.theme-sunset h2.text-gray-800,
body.theme-sunset h3.text-gray-800,
body.theme-sunset h4.text-gray-800,
body.theme-sunset .text-gray-800.font-semibold,
body.theme-sunset .font-semibold.text-gray-800 {
  color: #7c2d12 !important;
}

body.theme-sunset .text-gray-700 {
...
body.theme-sunset .text-gray-400 {
  color: #f97316 !important;
}

/* Button utama */
body.theme-sunset .bg-gray-800,
body.theme-sunset button.bg-gray-800,
body.theme-sunset .bg-gray-800.rounded-md,
body.theme-sunset .px-3.py-1\.5.bg-gray-800 {
  background-color: #9a3412 !important;
}
...
/* Hover states */
body.theme-sunset .hover\:bg-gray-50:hover {
  background-color: #ffedd5 !important;
}

body.theme-sunset .hover\:bg-gray-100:hover {
  background-color: #fed7aa !important;
}
...
body.theme-emerald .modal-card.bg-white,
body.theme-emerald .rounded-lg.bg-white {
  background-color: #ffffff !important;
}

/* Background abu-abu jadi warna emerald */
body.theme-emerald .bg-gray-50,
body.theme-emerald .rounded-lg.bg-gray-50,
body.theme-emerald .bg-gray-50.rounded-xl,
body.theme-emerald .bg-gray-50.rounded-lg,
body.theme-emerald .bg-gray-50.rounded-md {
  background-color: #ecfdf5 !important;
}

body.theme-emerald .bg-gray-100,
body.theme-emerald .bg-gray-100.rounded-md {
  background-color: #d1fae5 !important;
}

body.theme-emerald .bg-gray-200 {
  background-color: #a7f3d0 !important;
}

/* Border */
body.theme-emerald .border-gray-100,
body.theme-emerald .border.border-gray-100 {
  border-color: #d1fae5 !important;
}

body.theme-emerald .border-gray-200,
body.theme-emerald .border.border-gray-200 {
  border-color: #a7f3d0 !important;
}

body.theme-emerald .border-gray-300 {
  border-color: #6ee7b7 !important;
}

/* Text */
body.theme-emerald .text-gray-800,
body.theme-emerald h1.text-gray-800,
body.theme-emerald h2.text-gray-800,
body.theme-emerald h3.text-gray-800,
body.theme-emerald h4.text-gray-800,
body.theme-emerald .text-gray-800.font-semibold,
body.theme-emerald .font-semibold.text-gray-800 {
  color: #064e3b !important;
}

body.theme-emerald .text-gray-700 {
...
body.theme-emerald .text-gray-400 {
  color: #34d399 !important;
}

/* Button */
body.theme-emerald .bg-gray-800,
body.theme-emerald button.bg-gray-800,
body.theme-emerald .bg-gray-800.rounded-md,
body.theme-emerald .px-3.py-1\.5.bg-gray-800 {
  background-color: #047857 !important;
}
...
/* Hover states */
body.theme-emerald .hover\:bg-gray-50:hover {
  background-color: #d1fae5 !important;
}
...
/* Priority badges - biar tetep keliatan */
body.theme-sunset .bg-red-50,
body.theme-emerald .bg-red-50 {
  background-color: #fef2f2 !important;
}
body.theme-sunset .bg-orange-50,
body.theme-emerald .bg-orange-50 {
  background-color: #fff7ed !important;
}
body.theme-sunset .bg-green-50,
body.theme-emerald .bg-green-50 {
  background-color: #f0fdf4 !important;
}

/* Text untuk priority badges */
body.theme-sunset .text-red-600,
body.theme-emerald .text-red-600 {
  color: #dc2626 !important;
}
body.theme-sunset .text-orange-600,
body.theme-emerald .text-orange-600 {
  color: #ea580c !important;
}
body.theme-sunset .text-green-600,
body.theme-emerald .text-green-600 {
  color: #16a34a !important;
}

/* Shadow adjustment */
body.theme-sunset .shadow-lg,
body.theme-sunset .shadow-md,
body.theme-sunset .shadow-sm {
  box-shadow: 0 1px 3px 0 rgba(124, 45, 18, 0.1), 0 1px 2px -1px rgba(124, 45, 18, 0.1) !important;
}

body.theme-emerald .shadow-lg,
body.theme-emerald .shadow-md,
body.theme-emerald .shadow-sm {
  box-shadow: 0 1px 3px 0 rgba(6, 78, 59, 0.1), 0 1px 2px -1px rgba(6, 78, 59, 0.1) !important;
}
</style>